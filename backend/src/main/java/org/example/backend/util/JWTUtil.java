...
public class JWTUtil {
    ...
    static {
        String secretKeyString = "himynameiskimjihunmyyoutubechann"; // 32자리 평문
    ...
    public static String createJWT(String username, String role, Boolean isAccess) { // isAccess == False 이면 Refresh
